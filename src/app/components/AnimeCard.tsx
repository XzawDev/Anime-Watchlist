...
const AnimeCard = ({ anime }: { anime: Anime }) => {
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_20px_40px_-20px,rgba(0,0,0,0.7)] transition-transform hover:-translate-y-1.5 hover:shadow-[0_30px_60px_-24px,rgba(0,0,0,0.8)]">
        ...
        <div className="relative aspect-[2/3] w-full overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-3 opacity-0 group-hover:opacity-100 transition-opacity">
            <p className="text-[11px] text-zinc-200 line-clamp-3 leading-snug">
              {/* Description would be available in full anime data */}
